    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('PROJECT_MANAGER', 'Project Manager'), ('MEMBER', 'Member')], default='MEMBER', max_length=15)),
                ('date_of_hire', models.DateField(blank=True, null=True)),
                ('profile_path', models.ImageField(blank=True, null=True, upload_to='profiles/')),
